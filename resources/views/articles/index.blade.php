    ...
    @foreach($articles as $article)
        <div class="bg-white border border-zinc-300 rounded-lg p-4 mb-3 flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <x-ui.button href="{{ route('articles.inspect', $article) }}" variant="primary" size="xs" class="gap-2!">
                    <x-heroicon-o-magnifying-glass class="w-4 aspect-square" />
                    Inspect
                </x-ui.button>
                <x-ui.button href="{{ route('articles.edit', $article) }}" variant="secondary" size="xs" class="gap-2!">
