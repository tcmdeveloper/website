...
>
    ...
    <x-ui.card class="max-w-4xl px-16 py-16">
        ...
        <form
            ...
            <div
                ...
                class="mt-12 border-t border-zinc-300 flex flex-col text-lg"
            >
                ...
                {{-- Name --}}
                <div class="grid grid-cols-12 items-center border-b border-zinc-200 py-8">
                ...
                {{-- State --}}
                <div
                    class="grid grid-cols-12 items-center border-b border-zinc-200 py-8"
                    x-show="country === 'US'"
                    x-transition
                >
                    <span class="col-span-5 text-zinc-500 font-light">
