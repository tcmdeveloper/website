...
>
    ...
    <div class="justify-self-start lg:w-80 md:w-64 w-16">
        <a href="/">
            <img 
                ...
                srcset="
                    /images/true-crime-metrix-logo-xs.png 64w,
                    /images/true-crime-metrix-logo-sm.png 128w,
                    /images/true-crime-metrix-logo.png 256w
                "
                sizes="auto"
                alt="True Crime Metrix"
                class="h-7 aspect-square"
            >            
        </a>
    </div>
    ...
    >
        ...
        <div class="w-full p-8 mt-32 flex flex-col items-center space-y-5 text-5xl md:text-6xl font-heading font-bold">
            <a href="{{ route('cases.index') }}" class="whitespace-nowrap text-zinc-100 hover:text-yellow-300">Cases</a>
            <a href="{{ route('articles.index') }}" class="whitespace-nowrap text-zinc-100 hover:text-yellow-300">Articles</a>
            <a href="{{ route('categories.index') }}" class="whitespace-nowrap text-zinc-100 hover:text-yellow-300">Categories</a>
            <a href="{{ route('contact.show') }}" class="whitespace-nowrap text-zinc-100 hover:text-yellow-300">Contact me</a>
        </div>
