        ...
        >
            ...
            <form id="articleForm" method="POST" action="{{ route('admin.articles.store') }}" class="space-y-4">
                ...
                <div class="mt-4">
                    ...
                    <label class="block mb-1 text-sm text-stone-500 font-medium">
                        Content
                    </label>
...
>
    ...
    x-ref="content"
    name="content"
    class="w-full border rounded p-2 min-h-[500px]"
    placeholder="Write Markdown..."
>{{ old('content') }}</textarea>
                        </div>

                        {{-- Preview --}}
                        <div class="border rounded p-4 bg-white prose min-h-[500px] overflow-auto">
